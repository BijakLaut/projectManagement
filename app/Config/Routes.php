...
$routes->add('/addSegment', 'Dashboard::addSegment');
$routes->post('/addUnit', 'Dashboard::addUnit');
$routes->post('/editUnit', 'Dashboard::editUnit');
$routes->post('/checkInput', 'Dashboard::checkInput');
$routes->delete('/delete/(:any)/(:any)', 'Dashboard::delete/$1/$2');
