...
<div class="container">
    ...
    <?php if (session()->getFlashdata('replyEdited')) : ?>
        <div class="alert alert-success" role="alert">
            <?= session()->getFlashdata('replyEdited'); ?>
        </div>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 mt-lg-5">
            <form action="<?= base_url('updateReply') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                <input type="hidden" name="replyid" value="<?= $form['reply_id'] ?>">
                <input type="hidden" name="forumid" value="<?= $form['forum_parent'] ?>">
